...
class UserinterfaceApp:
    ...
    def __init__(self, master=None):
        ...
        self.img = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Background.jpg'))      
        ...
        self.canvas_1.config(background='#000000', height='150', width='150')
        ...
        self.canvas_4.place(anchor='nw', height='150', width='150', x='0', y='150')
        self.canvas_5 = tk.Canvas(self.frame_1_1)
        self.canvas_5.config(background='#000000', height='150', width='150')
        self.canvas_5.place(anchor='nw', height='150', width='150', x='150', y='150')
        self.canvas_6 = tk.Canvas(self.frame_1_1)
        self.canvas_6.config(background='#000000', height='150', width='150')
        self.canvas_6.place(anchor='nw', height='150', width='150', x='300', y='150')
        self.canvas_7 = tk.Canvas(self.frame_1_1)
        self.canvas_7.config(background='#000000', height='150', width='150')
        self.canvas_7.place(anchor='nw', height='150', width='150', x='0', y='300')
        self.canvas_8 = tk.Canvas(self.frame_1_1)
        self.canvas_8.config(background='#000000', height='150', width='150')
        self.canvas_8.place(anchor='nw', height='150', width='150', x='150', y='300')
        self.canvas_9 = tk.Canvas(self.frame_1_1)
        self.canvas_9.config(background='#000000', height='150', width='150')
        self.canvas_9.place(anchor='nw', height='150', width='150', x='300', y='300')
        self.canvas_10 = tk.Canvas(self.frame_1_1)
        self.canvas_10.config(background='#000000', height='150', width='150')
        self.canvas_10.place(anchor='nw', height='150', width='150', x='0', y='450')
        self.canvas_11 = tk.Canvas(self.frame_1_1)
        self.canvas_11.config(background='#000000', height='150', width='150')
        self.canvas_11.place(anchor='nw', height='150', width='150', x='150', y='450')
        self.canvas_12 = tk.Canvas(self.frame_1_1)
        self.canvas_12.config(background='#000000', height='150', width='150')
        self.canvas_12.place(anchor='nw', height='150', width='150', x='300', y='450')
        ...
        self.img2 = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Heart Rate.png'))      
        ...
        self.img3 = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Temperature.png'))      
        ...
        self.weight = tk.Label(self.frame_1_2_3_4_5, font=(None, 32))
        self.weight.config(background='#000000', foreground='#ff8040', text='-- to --')
        self.weight.place(anchor='nw', height='73', width='239', x='2', y='50')
        self.img4 = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Weight.png'))      
        ...
        self.img5 = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Urine Bag.png'))      
        ...
        self.canvas_6_1.config(background='#000000', height='175', width='750')
        ...
        self.img6 = ImageTk.PhotoImage(Image.open('C:\\Users\\ammar\\OneDrive - Higher Education Commission\\Final Year Project\\User_Interface\\Alert.png'))      
        ...
        self.frame_1.config(height='768', width='1366')
    ...
    def update(self):
        if (testing):
            self.alert.config(text = 'One or more modules not connected!\nTest mode activated')
        ...
        wt = weightValues[12].replace('>', '').replace('Calibrated', '')
